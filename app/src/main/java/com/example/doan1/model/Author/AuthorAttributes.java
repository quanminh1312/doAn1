...
public class AuthorAttributes {
    ...
    public String getMelonBook() {
        return melonBook;
    }

    public void setMelonBook(String melonBook) {
    ...
    public void setFanBox(String fanBox) {
        this.fanBox = fanBox;
    }
    ...
    public void setNicoVideo(String nicoVideo) {
    ...
    public void setSkeb(String skeb) {
        this.skeb = skeb;
    }
    ...
    public void setFantia(String fantia) {
        this.fantia = fantia;
    }
